...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("sticky top-0 shadow-sm [&_tr]:border-b", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "grainy h-7 whitespace-nowrap bg-white px-1 text-left align-middle font-semibold [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
